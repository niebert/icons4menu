...
**REMARK (2023/04/03):** Downloading a single icon from the repository is not allowed anymore by GitHub and also the display of single icons via the SRC-tag is not allowed. So updating single icons with a script from this repository does not work.

...
| Icon | File | Folder  |  Source File | Licence  | Group |
|---|---|---|---|---|---|
| <span style='bgcolor:#888888'><img src="https://niebert.github.io/icons4menu/img/icons-svg/camera.svg" width="20"> </span> | [`camera.svg`](https://jquerymobile.com/download/)  | `img/icons-svg`  | [`JQ-camera.svg`](https://jquerymobile.com/download/) | <a href='https://creativecommons.org/publicdomain/zero/1.0/deed.en' target='_blank'>CC0</a> | `device`  | 

...
function getIndent(level,pIndent) {
    var result = '';
    var vIndent = pIndent || "    ";
    if (level < 0) {
...
function reduceVarName(pName) {
  // CONVERTS
  //    sldasSAD sdX-244 = "2454 SDsf"
  // TO
  //    sldasSADsdX244= "2454 SDsf"
...
function removeIndent(pText,pIndent) {
...
module.exports = {
  ...
  "replaceStringReverse": replaceStringReverse,
  "capitalizeFirstLetter": capitalizeFirstLetter,
  "randomString4Chars": randomString4Chars,
  "style_html": style_html,
  "title2filename": title2filename,
  "reduceVarName": reduceVarName,
  "removeExtension4File": removeExtension4File,
  "removeIndent": removeIndent,
  "createIndent": createIndent,
  "isString": isString,
  "removeSpaces": removeSpaces,
  "decodeURL": decodeURL,
  "getDirname4URL": getDirname4URL,
  "encodeURLparam": encodeURLparam,
  "decodeURLparam": decodeURLparam,
  "getProtocol4URL": getProtocol4URL,
  "getNameExt": getNameExt,
  "get_extension": get_extension,
  "getNameExt4URL": getNameExt4URL,
  "getName4URL": getName4URL
};
